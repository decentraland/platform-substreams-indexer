    ...
    pub mod functions {
        ...
        impl Collections {
            const METHOD_ID: [u8; 4] = [253u8, 189u8, 160u8, 236u8];
            pub fn decode(
                call: &substreams_ethereum::pb::eth::v2::Call,
            ) -> Result<Self, String> {
        ...
        impl substreams_ethereum::Function for Collections {
        ...
        impl substreams_ethereum::rpc::RPCDecodable<Vec<u8>> for Collections {
            fn output(data: &[u8]) -> Result<Vec<u8>, String> {
                Self::output(data)
            }
        }
        #[derive(Debug, Clone, PartialEq)]
        pub struct CollectionsSize {}
        impl CollectionsSize {
            const METHOD_ID: [u8; 4] = [223u8, 175u8, 51u8, 233u8];
            pub fn decode(
                call: &substreams_ethereum::pb::eth::v2::Call,
            ) -> Result<Self, String> {
                Ok(Self {})
        ...
        impl substreams_ethereum::Function for CollectionsSize {
            const NAME: &'static str = "collectionsSize";
            fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
                Self::match_call(call)
            }
            fn decode(
        ...
        impl GetAddress {
            const METHOD_ID: [u8; 4] = [175u8, 34u8, 35u8, 153u8];
            pub fn decode(
                call: &substreams_ethereum::pb::eth::v2::Call,
            ) -> Result<Self, String> {
                let maybe_data = call.input.get(4..);
        ...
        #[derive(Debug, Clone, PartialEq)]
        pub struct IsCollectionFromFactory {
            pub param0: Vec<u8>,
        }
        impl IsCollectionFromFactory {
            const METHOD_ID: [u8; 4] = [192u8, 48u8, 0u8, 17u8];
            pub fn decode(
                call: &substreams_ethereum::pb::eth::v2::Call,
            ) -> Result<Self, String> {
                let maybe_data = call.input.get(4..);
        ...
        impl substreams_ethereum::Function for IsCollectionFromFactory {
            const NAME: &'static str = "isCollectionFromFactory";
            fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
                Self::match_call(call)
            }
            fn decode(
        ...
        impl substreams_ethereum::rpc::RPCDecodable<bool> for IsCollectionFromFactory {
    ...
    pub mod events {
        ...
        impl substreams_ethereum::Event for ImplementationSet {
            const NAME: &'static str = "ImplementationSet";
